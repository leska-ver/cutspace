<?
  ...
  $dbname = 'ci54422_cutspace';//Из сайта имя "Базы данных MySQL"/
  $dbuser = 'ci54422_cutspace';//Из сайта имя "Базы данных MySQL"/
  ...
  $stmt = $pdo->prepare('INSERT INTO orders(email) VALUES(:email)');//name, tel, message, :name, :tel, :message, 
